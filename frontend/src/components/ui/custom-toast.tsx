...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 left-1/2 z-[100] flex max-h-screen w-full max-w-md -translate-x-1/2 flex-col-reverse p-4 sm:flex-col",
      className
    )}
    {...props}
  />
...
const ProgressBar = ({ duration = 5000 }: { duration?: number }) => {
